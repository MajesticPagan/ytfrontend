...
import { TbHexagonLetterS, TbThumbUp, TbFlame, TbFlag } from "react-icons/tb";
...
export const globalMenu: Array<MenuItemProps> = [
	{
		icon: BiHomeAlt,
		label: "Início",
		to: "/",
...
export const userMenu: Array<MenuItemProps> = [
	{
		icon: BiLibrary,
		label: "Biblioteca",
		to: "/library",
	...
	{
		icon: BiVideo,
		label: "Os seus vídeos",
		to: "/library/videos",
	},
	{
		icon: BiTime,
		label: "Ver mais tarde",
		to: "/library/watchlater",
	},
	{
		icon: TbThumbUp,
		label: "Vídeos de que gostou",
		to: "/library/liked",
	},
];

export const categoryMenu: Array<MenuItemProps> = [
	{
		icon: TbFlame,
		label: "Tendências",
		to: "/feed/trending",
...
export const otherMenu: Array<MenuItemProps> = [
	{
		icon: BiCog,
		label: "Definições",
		to: "/settings",
...
export const videos: Array<VideoProps> = [
	{
		thumbnailUrl:
		...
		channelImageUrl:
			"https://yt3.ggpht.com/ytc/AGIKgqMTMTVTkIs5eG2jOZkWwta5U_zS_wYQAearS1fU=s68-c-k-c0x00ffffff-no-rj",
